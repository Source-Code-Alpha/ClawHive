...
const TONE_PROMPT = [
  ...
  "Available agents are the ones configured in this ClawHive instance — see the agents/ directory",
  "for the current roster (e.g. coding, designer, researcher, finance, life, social, auditor).",
